...
access(all) contract USDC: FungibleToken {
  ...
  access(all) resource Administrator {
    ...
    // transactions/usdc/minter/setup_usdc_minter.cdc
    // then the admin account running:
    // transactions/usdc/admin/deposit_usdc_minter.cdc
    //
  ...
  init() {
    ...
    self.MinterProxyPublicPath = /public/usdcMinterProxy
    self.MinterProxyStoragePath = /storage/usdcMinterProxy
